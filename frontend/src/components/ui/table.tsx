...
/** Wrap tables so wide content scrolls inside the card, never the page body. */
...
export const TableHead = forwardRef<HTMLTableCellElement, ThHTMLAttributes<HTMLTableCellElement>>(
  ({ className, ...props }, ref) => (
    <th
      ref={ref}
      className={cn(
        'h-11 px-4 text-left align-middle text-xs font-semibold uppercase tracking-wide text-ink-subtle',
        'whitespace-nowrap',
        className,
      )}
      {...props}
